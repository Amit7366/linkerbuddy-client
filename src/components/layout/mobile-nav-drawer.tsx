      ...
      {open ? (
        <>
          <motion.div
            ...
            role="presentation"
            aria-hidden
            className="fixed inset-0 z-[60] bg-black/40 opacity-0 desktop:hidden [-webkit-tap-highlight-color:transparent]"
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            exit={{ opacity: 0 }}
            transition={{ duration: reduce ? 0.16 : DURATION, ease: EASE }}
            onClick={onClose}
          />
          <motion.div
            ...
            <div className="flex shrink-0 flex-col px-5 pt-3">
              ...
              <div className="flex items-center justify-between gap-3 pb-3">
                ...
                <button
                  ref={closeRef}
                  type="button"
                  className="inline-flex size-9 shrink-0 items-center justify-center rounded-full border-0 bg-white/10 text-white [-webkit-tap-highlight-color:transparent]"
