  ...
  return (
    <button
      ...
      className={cn(
        ...
        "bg-navy text-white shadow-[0_12px_40px_rgba(7,27,61,0.35)]",
        "ring-2 ring-white/20 transition hover:scale-105 hover:bg-[#0c2a56]",
        "tablet:right-6",
        "animate-[cart-pulse_2s_ease-in-out_infinite]",
      )}
    >
      <ShoppingCart className="size-5" />
      <span className="absolute -top-1 -right-1 grid min-w-5 place-items-center rounded-full bg-[#2679f2] px-1.5 py-0.5 text-[10px] font-extrabold leading-none">
        {count}
      </span>
    </button>
  );
